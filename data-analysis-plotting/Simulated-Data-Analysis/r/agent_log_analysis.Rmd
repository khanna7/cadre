...
```{r}
agent_dt <- fread("/oscar/data/akhann16/akhann16/cadre_simulated_data/emews_experiments/test-alt-loc/instance_1/output/agent_log.csv")
str(agent_dt)
