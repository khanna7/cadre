...
## Compare data on Co-Use to Falk et al. 
...
## Joint Distributions on Alcohol and Tobacco Use
...
Joint probability of former or current smoking and alcohol use (i.e., not lifetime abstainer):
...
# Print the joint probability of current smokers and alcohol users
cat("Joint probability of never smoker and lifetime abstainer: ", 
