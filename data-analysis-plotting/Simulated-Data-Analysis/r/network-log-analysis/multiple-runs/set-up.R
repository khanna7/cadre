...
for (i in 1:num_instances){
  ...
  network_dt <- fread(paste0(sim_data_path, "network_log.csv"))
...
saveRDS(all_instances_data, here("network-log-analysis", "multiple-runs" ,"rds-outs", "all_instances_data.RDS"))
