...
graph <- set_node_attrs(graph, "color", ifelse(ndf$smoking_status == "Current", "red", ifelse(ndf$alc_use_status == 3, "blue", "gray")))
...
```{r}
# Create a legend
legend <- data.frame(group = c("Recently Released", "Currently Smoking", "AUD"),
                     color = c("black", "red", "blue"),
                     shape = c("square", "circle", "circle"))
