...
We model transition between Current Smokers and Former Smokers for 
each subpopulation defined above:

We model smoking initiation rates as transitions from Never to Current Smoker 
status.    
